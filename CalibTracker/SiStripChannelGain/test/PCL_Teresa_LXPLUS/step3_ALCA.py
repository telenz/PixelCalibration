...
# with command line options: step3 --datatier ALCARECO --conditions auto:com10 -s ALCA:PromptCalibProdSiStripGains --eventcontent ALCARECO -n 100 --dbsquery=file dataset=/MinimumBias/Run2012C-SiStripCalMinBias-v2/ALCARECO run=200190 --fileout file:step3.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('step3 nevts:100000000'),
